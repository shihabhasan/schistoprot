...
from app.models import SecretoryLessConservative
...
#---------------------SECRETORY LESS CONSERVATIVE------------------

def run_secretory_less_conservative(filename, secretory_email, feature_mode, task_id):
    parameter=""
    test_features=""
    test_para=""
    seqID_list=[]
    ...
    for record in records:
        ...
        data=SecretoryLessConservative.objects.filter(sequence=hash_sequence)
        if len(data)==0:
   ...
   #---------------------WORKING WITH SCIKIT-LEARN------------
    if parameter!="":
        ...
        train_positive_file="secretory_positive_less_conservative.csv"
